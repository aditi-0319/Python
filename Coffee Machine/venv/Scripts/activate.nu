...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Chopr\PycharmProjects\Coffee Machine\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Chopr\PycharmProjects\Coffee Machine\venv\Scripts\deactivate.nu'
